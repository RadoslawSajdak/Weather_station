...
void lcd_init(){
	...
	lcd_write_instruction(LCD_VISIBLE | LCD_V_DISPLAY_ON | LCD_V_CURSOR_ON | LCD_V_BLINK_ON);
...
uint8_t icon=0;   //global variable - it count custom char in memory
